...
public class Muslim extends AppCompatActivity {
        ...
        countbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(beatvalue < 100){
                    ...
                    Vibrator v = (Vibrator) getSystemService(Muslim.VIBRATOR_SERVICE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.ShareMenuId){
            ...
            Intent intent = new Intent(Muslim.this,FeedBack.class);
            startActivity(intent);
        }
        else if (id == R.id.AboutMenuId){

            AlertDialog.Builder alertdialogbuilder = new AlertDialog.Builder(Muslim.this);
